...
== View helpers
include bento helpers
  class ApplicationController < ActionController::Base
    include Bento::Controllers::Helpers
  end
You can now use the current_account helper in your controllers and views which returns the currently logged in user's account.

== Controller convenience
If you're using inherited_resources in your controllers you can do:
  class MyController < ApplicationController
    scoped_to_account
  end
to scope your resource to the current account.
